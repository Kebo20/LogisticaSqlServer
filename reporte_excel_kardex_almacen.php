...
//$objPHPExcel->getActiveSheet()->getStyle('A1:B10')->applyFromArray($estiloTituloReporte);
...
$almacen=$olog->ListarAlmacenSucursalxid($_GET['almacen'])->fetch();
...
$objPHPExcel->getActiveSheet()->setCellValue('A10', 'Almacén');
$objPHPExcel->getActiveSheet()->setCellValue('B10', $almacen['nombre_almacen']." - ".$almacen['nombre_sucursal']);
...
//CUERPO
$lista = $olog->ListarKardexAlmacen($_GET['producto'],$_GET['almacen'],0,10000);
$i = 0;
